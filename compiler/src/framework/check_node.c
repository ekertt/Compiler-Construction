...
node           *CHKMsymboltable(node * arg_node, info * arg_info) {
	...
	SYMBOLTABLE_ENTRY(arg_node) = CHKMTRAV(SYMBOLTABLE_ENTRY(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMsymboltableentry(node * arg_node, info * arg_info) {
	...
	SYMBOLTABLEENTRY_LINK(arg_node) = CHKMattribLink(SYMBOLTABLEENTRY_LINK(arg_node), arg_info);
	SYMBOLTABLEENTRY_TABLE(arg_node) = CHKMTRAV(SYMBOLTABLEENTRY_TABLE(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *

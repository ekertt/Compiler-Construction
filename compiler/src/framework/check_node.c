...
node           *CHKMdowhile(node * arg_node, info * arg_info) {
	...
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	DOWHILE_CONDITION(arg_node) = CHKMTRAV(DOWHILE_CONDITION(arg_node), arg_info);
...
node           *CHKMfor(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKMfor");
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	FOR_FIRST(arg_node) = CHKMTRAV(FOR_FIRST(arg_node), arg_info);
	FOR_SECOND(arg_node) = CHKMTRAV(FOR_SECOND(arg_node), arg_info);
	FOR_THIRD(arg_node) = CHKMTRAV(FOR_THIRD(arg_node), arg_info);
...
node           *CHKMfunheader(node * arg_node, info * arg_info) {
	...
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	FUNHEADER_PARAM(arg_node) = CHKMTRAV(FUNHEADER_PARAM(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMglobaldec(node * arg_node, info * arg_info) {
	...
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	GLOBALDEC_IDS(arg_node) = CHKMTRAV(GLOBALDEC_IDS(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMglobaldef(node * arg_node, info * arg_info) {
	...
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	GLOBALDEF_IDS(arg_node) = CHKMTRAV(GLOBALDEF_IDS(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMids(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKMids");
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	IDS_EXPR(arg_node) = CHKMTRAV(IDS_EXPR(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMifelse(node * arg_node, info * arg_info) {
	...
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	IFELSE_CONDITION(arg_node) = CHKMTRAV(IFELSE_CONDITION(arg_node), arg_info);
...
node           *CHKMprogram(node * arg_node, info * arg_info) {
	...
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	PROGRAM_DECLARATIONS(arg_node) = CHKMTRAV(PROGRAM_DECLARATIONS(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
 ...
 *
 ***************************************************************************/
node           *CHKMvardec(node * arg_node, info * arg_info) {
	DBUG_ENTER("CHKMvardec");
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	VARDEC_NEXT(arg_node) = CHKMTRAV(VARDEC_NEXT(arg_node), arg_info);
	VARDEC_EXPRESSIONS(arg_node) = CHKMTRAV(VARDEC_EXPRESSIONS(arg_node), arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
 *
...
node           *CHKMwhile(node * arg_node, info * arg_info) {
	...
	NODE_ERROR(arg_node) = CHKMTRAV(NODE_ERROR(arg_node), arg_info);
	WHILE_CONDITION(arg_node) = CHKMTRAV(WHILE_CONDITION(arg_node), arg_info);

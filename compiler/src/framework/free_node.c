...
node           *FREEdowhile(node * arg_node, info * arg_info) {
	...
	DOWHILE_CONDITION(arg_node) = FREETRAV(DOWHILE_CONDITION(arg_node), arg_info);
...
node           *FREEfor(node * arg_node, info * arg_info) {
	...
	FOR_FIRST(arg_node) = FREETRAV(FOR_FIRST(arg_node), arg_info);
	FOR_SECOND(arg_node) = FREETRAV(FOR_SECOND(arg_node), arg_info);
	FOR_THIRD(arg_node) = FREETRAV(FOR_THIRD(arg_node), arg_info);
...
node           *FREEfunheader(node * arg_node, info * arg_info) {
	...
	FUNHEADER_PARAM(arg_node) = FREETRAV(FUNHEADER_PARAM(arg_node), arg_info);
	result = NULL;
...
node           *FREEglobaldec(node * arg_node, info * arg_info) {
	...
	GLOBALDEC_IDS(arg_node) = FREETRAV(GLOBALDEC_IDS(arg_node), arg_info);
	result = NULL;
...
node           *FREEglobaldef(node * arg_node, info * arg_info) {
	...
	GLOBALDEF_IDS(arg_node) = FREETRAV(GLOBALDEF_IDS(arg_node), arg_info);
	result = NULL;
...
node           *FREEids(node * arg_node, info * arg_info) {
	...
	IDS_EXPR(arg_node) = FREETRAV(IDS_EXPR(arg_node), arg_info);
	result = NULL;
...
node           *FREEifelse(node * arg_node, info * arg_info) {
	...
	IFELSE_CONDITION(arg_node) = FREETRAV(IFELSE_CONDITION(arg_node), arg_info);
...
node           *FREEprogram(node * arg_node, info * arg_info) {
	...
	PROGRAM_DECLARATIONS(arg_node) = FREETRAV(PROGRAM_DECLARATIONS(arg_node), arg_info);
	result = NULL;
...
node           *FREEvardec(node * arg_node, info * arg_info) {
	...
	VARDEC_EXPRESSIONS(arg_node) = FREETRAV(VARDEC_EXPRESSIONS(arg_node), arg_info);
...
node           *FREEwhile(node * arg_node, info * arg_info) {
	...
	WHILE_CONDITION(arg_node) = FREETRAV(WHILE_CONDITION(arg_node), arg_info);

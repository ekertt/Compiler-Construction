 ...
 *
 ***************************************************************************/
node           *EVALfundec(node * arg_node, info * arg_info) {
 ...
 *
 ***************************************************************************/
node           *EVALfunheader(node * arg_node, info * arg_info) {
 ...
 *
 ***************************************************************************/
node           *EVALglobdec(node * arg_node, info * arg_info) {
	DBUG_ENTER("EVALglobdec");
	arg_node = TRAVcont(arg_node, arg_info);
	DBUG_RETURN(arg_node);
}
/** <!--******************************************************************-->
